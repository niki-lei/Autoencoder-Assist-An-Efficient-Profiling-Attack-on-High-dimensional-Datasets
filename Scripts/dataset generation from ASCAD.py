...
# Code is ported from https://github.com/ANSSI-FR/ASCAD
...
def labelize(plaintexts, keys):
    return AES_Sbox[plaintexts[:, 0] ^ keys[:, 0]]


# TODO: sanity checks on the parameters
def extract_traces(traces_file, labeled_traces_file, profiling_index, attack_index, target_points, profiling_desync=0, attack_desync=0):
...
original_raw_traces_file = "ATMega8515_raw_traces.h5"

profiling_index = [n for n in range(0, 50000)]
attack_index = [n for n in range(50000, 60000)]
target_points=[n for n in range(44400,47400)] 

profiling_desync=0
attack_desync=0
extract_traces(original_raw_traces_file, "./ASCAD_Sbox3_3000_test.h5", profiling_index, attack_index, target_points, profiling_desync=0, attack_desync=0)
#extract_traces(original_raw_traces_file, "ASCAD_desync50.h5" , profiling_index, attack_index, target_points, profiling_desync=0, attack_desync = 50)
#extract_traces(original_raw_traces_file, "ASCAD_desync100.h5", profiling_index, attack_index, target_points, profiling_desync=0, attack_desync = 100)
